...
const CourseForm = () => {
  ...
  const [courseCode, setCourseCode] = useState(""); // State for input field inside modal
  ...
  const handleModalSubmit = async () => {
    if (courseCode === "") {
      setErrors("Course code is required");
    }
    ...
    try {
      ...
      // console.log("Getting Error in course Deleting Under Catch");
    }
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded shadow-lg max-w-md w-full">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Please enter the course code of the course you want to delete.
              </p>
              <input
                type="text"
