...
const CourseForm = () => {
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      case 'title':
        error = value.length > 100 ? 'Title must be 100 characters or less' : '';
        break;
      case 'courseCode':
        error = !/^[A-Za-z]{3}\d{3}$/.test(value) ? 'Invalid course code format' : '';
        break;
      case 'courseCredit':
        error = isNaN(value) || value < 0 ? 'Credit must be a positive number' : '';
        break;
      default:
        break;
    }
          ...
          <div className="max-w-md mx-auto">
            <div className="flex items-center space-x-5">
              ...
              <div className="block pl-2 font-semibold text-xl self-start text-gray-700">
                ...
                <p className="text-sm text-gray-500 font-normal leading-relaxed">Enter the details of the new course below.</p>
              </div>
            </div>
            <form className="divide-y divide-gray-200" onSubmit={handleSubmit}>
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                <div className="flex flex-col">
                  <label className="leading-loose" htmlFor="title">Course Title</label>
                  <div className="relative text-gray-400">
                    ...
                    <input
                      ...
                      id="title"
                      name="title"
                      className={`pl-10 pr-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600 ${errors.title ? 'border-red-500' : ''}`}
                ...
                <div className="flex flex-col">
                  <label className="leading-loose" htmlFor="description">Course Description</label>
                  <textarea
                    id="description"
                    name="description"
                    rows="3"
                ...
                <div className="flex flex-col">
                  <label className="leading-loose" htmlFor="semester">Semester</label>
                ...
                <div className="flex flex-col">
                  <label className="leading-loose" htmlFor="courseCode">Course Code</label>
                  <div className="relative text-gray-400">
                    ...
                    <input
                      ...
                      id="courseCode"
                      name="courseCode"
                      className={`pl-10 pr-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600 ${errors.courseCode ? 'border-red-500' : ''}`}
                      placeholder="CSE101"
                ...
                <div className="flex flex-col">
                  <label className="leading-loose" htmlFor="courseCredit">Course Credit</label>
                  <div className="relative text-gray-400">
                    ...
                    <input
                      ...
                      id="courseCredit"
                      name="courseCredit"
                      className={`pl-10 pr-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600 ${errors.courseCredit ? 'border-red-500' : ''}`}
                      placeholder="3"
                  ...
                  {errors.courseCredit && <p className="text-red-500 text-xs mt-1">{errors.courseCredit}</p>}
                </div>
                <div className="flex flex-col">
                  <label className="leading-loose" htmlFor="courseType">Course Type</label>
                  <select
                    id="courseType"
                    name="courseType"
                    className="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
