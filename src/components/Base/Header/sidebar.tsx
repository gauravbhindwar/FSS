...
import { FaUser, FaCog, FaChartBar, FaSignOutAlt, FaArrowRight } from 'react-icons/fa';
...
const UserDashboard = () => {
  ...
  const websiteFeatures = [
    { title: 'Data Analytics', description: 'Powerful tools for analyzing and visualizing your data', icon: <FaChartBar className="text-3xl mb-4 text-orange-500" /> },
    { title: 'User Management', description: 'Efficient system for managing user accounts and permissions', icon: <FaUser className="text-3xl mb-4 text-orange-500" /> },
    { title: 'Advanced Settings', description: 'Customize your experience with our advanced configuration options', icon: <FaCog className="text-3xl mb-4 text-orange-500" /> }
  ];
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          >
            <div className="flex items-center w-[fit-content]">
              ...
              <div>
                <h2 className="text-lg font-semibold mb-2">Subject Selection Form</h2>
                <p className="text-gray-700">Please click here to fill and submit the form for Subject Selection</p>
              </div>
            </div>
