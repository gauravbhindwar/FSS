        ...
        <div className="min-h-screen bg-gray-100 p-4 sm:p-8 md:p-10">
          ...
          >
            ...
            >
              ...
              <div className="flex items-center mb-4">
                <AiOutlineExclamationCircle className="text-red-600 mr-3" size={30} />
                <p className="text-gray-600">This action cannot be undone. Are you sure you want to delete this form?</p>
              </div>
              <div className="flex justify-end space-x-2">
                ...
                <motion.button
                  className="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-500"
